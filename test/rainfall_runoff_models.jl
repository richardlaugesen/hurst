...
@testset "GR4J" begin
    ...
    @testset "Benchmarks" begin
        ...
        typical = @belapsed gr4j_run_step(10, 5, $init_state, $params)
        ...
        huge_x4 = @belapsed gr4j_run_step(10, 5, $init_state, $params)
        ...
        evap_path = @belapsed gr4j_run_step(5, 100, $init_state, $params)
        precip_path = @belapsed gr4j_run_step(100, 5, $init_state, $params)
        @test isapprox(evap_path, precip_path, atol=1e-6)

        # simulation of 2 years data should take less than 50 milliseconds
        @test (@belapsed gr4j_simulate($data, $params, $init_state)) < (50 * 1e-3)
    end
end
